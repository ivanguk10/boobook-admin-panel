...
BookItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BookItemComponent, selectors: [["app-room-item"]], inputs: { book: "book" }, outputs: { OnDelete: "OnDelete" }, decls: 25, vars: 5, consts: [[1, "list-group-item", "field"], [1, "room-field"], [1, "image-part"], ["alt", "book image", 1, "book-img", 3, "src"], [1, "text-part"], ["type", "button", 1, "btn", "btn-outline-success", 3, "click"], ["type", "button", 1, "btn", "btn-outline-danger", 2, "margin-top", "10px", 3, "click"]], template: function BookItemComponent_Template(rf, ctx) { if (rf & 1) {
